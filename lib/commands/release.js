    ...
    function getNextTag() {
      if (options.tag) {
        ...
        return repo.tags().then(function(tags) {
          ...
          return versioningStrategy.getNextTag(project, tagNames, options);
        }).then(function(versions) {
          if (!versions || typeof versions.next !== 'string') {
            throw new SilentError("Tagging strategy must return object with a string `next` property");
          }
